<?php
    ...
    class Game
    {
        ...
        public function addGame()
        {
            ...
            $query = "INSERT INTO $this->tableName (PlayerID, SubID, TotalQ, CorrectAns, Score, createdAt) VALUES ($this->playerID, $this->subID, $this->totalQues, $this->correctAns, $this->score, $this->createdAt);";
